                           ...
                           <div class="p-20">
                             <table id="datatable" class="table table-bordered">
                               ...
                               <tbody>
                                 <?php foreach ($dp as $a): ?>
                                 <tr>
                                   <td style="text-align: center"><?php echo $a->idpesanan; ?></td>
                                   <td style="text-align: center"><?php echo $a->namapemesan; ?></td>
                                   ...
                                   <td style="text-align: center"> <?php if ($a->status == 'Belum Selesai'){ ?>
                                    ...
                                    <td style="text-align: center">
                                      ...
                                      <a href="<?php echo site_url('backend/detailpesanan/hapusdp/'.$a->iddetailpesanan); ?>" class="sa-params"><img width="20" height="20" src="<?php echo base_url('img/hapus.png'); ?>" data-toggle="tooltip" data-placement="bottom" data-original-title="Hapus Detail Pesanan"/></a>
                                    </td>
                     ...
                     <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" id="editdata<?=$b->iddetailpesanan; ?>">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           ...
                           <form class="form-horizontal" action="<?php echo base_url('backend/detailpesanan/editdp'); ?>" method="post" enctype="multipart/form-data" role="form">
                             <div class="modal-body">
                               ...
                               <div class="form-group">
                                 ...
                                 <div class="col-lg-9">
                                   <input type="text" name="idpesanan" class="form-control" value="<?= $b->idpesanan; ?>" readonly="readonly" >
                                 </div>
                               </div>
                               <div class="form-group">
                                 <label class="col-lg-3 col-sm-2 control-label">Nama Pemesan</label>
                                 <div class="col-lg-9">
                                   <input type="text" name="namapemesan" class="form-control" value="<?= $b->namapemesan; ?>" readonly="readonly" >
                                 </div>
                               </div>
                               <div class="form-group">
