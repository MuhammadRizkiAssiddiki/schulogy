            ...
            <div class="row">
              <div class="col-xs-12">
               <div class="card-box">
                   <div class="row">
                       <div class="col-lg-12">
                           <h4 class="header-title m-t-0">Schulogy - Konfigurasi Slide Foto</h4>
                           &nbsp;&nbsp;
                           ...
                           <div class="p-20">
                               <table class="table table-striped">
                                   ...
                                   <tbody>
                                     <?php $i =1 ; foreach ($slide as $a): ?>
                                       <tr>
                                         <td><?php echo $i++; ?></td>
                                         <td><?php echo $a->caption1; ?></td>
                                         <td><?php echo $a->caption2; ?></td>
                                         <td width="220px"><?php echo $a->caption3; ?></td>
                                         <td> <img src="<?php echo base_url('slidefoto/').$a->slider; ?>" alt="" width="120px" height="60px"> </td>
                                         <td><?php echo $a->status; ?></td>
                                         <td>
                                           <a href="" data-toggle="modal" data-target="#editdata<?=$a->idslider; ?>" disabled><img name="edit" width="20" height="20" src="<?php echo base_url('img/edit.png'); ?>" data-toggle="tooltip" data-placement="bottom" data-original-title="Edit Slide Foto" disabled/></a>
                                           <a href="<?php echo site_url('backend/slidefoto/hapusslide/'.$a->idslider); ?>" class="sa-params"><img width="20" height="20" src="<?php echo base_url('img/hapus.png'); ?>" data-toggle="tooltip" data-placement="bottom" data-original-title="Hapus Slide Foto"/></a>
                                         </td>
                                       </tr>
                                     <?php endforeach; ?>
                                   </tbody>
                   ...
                   <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" id="tambahdata">
                     <div class="modal-dialog">
                       <div class="modal-content">
                         ...
                         <form class="form-horizontal" action="<?php echo base_url('backend/slidefoto/tambahslide'); ?>" method="post" enctype="multipart/form-data" role="form">
                           <div class="modal-body">
                             ...
                             <div class="form-group">
                               ...
                               <div class="form-group">
                                 ...
                                 <div class="col-lg-9">
                                   <input type="file" name="slider" placeholder="Masukkan File Foto Slide">
                                 </div>
                               </div>
                             </div>
                           </div>
                   ...
                   <?php foreach($slide as $a): ?>
                     <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" id="editdata<?=$a->idslider; ?>">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <div class="modal-header">
                             <button type="button" aria-hidden="true" data-dismiss="modal" class="close">x</button>
                           ...
                           <form class="form-horizontal" action="<?php echo base_url('backend/slidefoto/editslide'); ?>" method="post" enctype="multipart/form-data" role="form">
                             <div class="modal-body">
                               <div class="form-group">
                                 <div class="col-lg-9 asik">
                                   <input type="hidden" id="idslide" name="idslide" class="form-control" value="<?= $a->idslider; ?>" readonly="readonly" >
                                 </div>
                               </div>
                               <div class="form-group">
                                 <label class="col-lg-3 col-sm-2 control-label">Caption 1 (Kata2 Untuk Baris Ke-1)</label>
                               ...
                               <div class="form-group">
                                 ...
                                 <div class="form-group">
                                   <label class="col-lg-3 col-sm-2 control-label">File Slide Foto</label>
                                   <div class="col-lg-9">
                                     <input id="uploadImage<?php echo $a->idslider; ?>" type="file" name="slider" onchange="PreviewImage(<?php echo $a->idslider; ?>);">
                                   </div> <br>
                                   <div class="col-lg-9">
                                     <img id="uploadPreview<?php echo $a->idslider; ?>" src="<?php echo base_url('slidefoto/').$a->slider; ?>" width="300px" height="100px" alt="">
                                   </div>
                                 </div>
                               </div>
                             </div>
