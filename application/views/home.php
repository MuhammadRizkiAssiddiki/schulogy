...
<html lang="en">
  <head>
    ...
    <title>Schulogy - Premium Shoes Treatment</title>
    ...
    <link href="<?php echo base_url('assets/frontend/'); ?>css/line-icons.css" rel="stylesheet">
    ...
    <link href="<?php echo base_url('assets/frontend/'); ?>css/nivo.lightbox.css" rel="stylesheet">
    ...
    <link href="<?php echo base_url('assets/frontend/'); ?>css/menu_sideslide.css" rel="stylesheet">
  ...
  <body>
    ...
    <header id="slider-area">
      <nav class="navbar navbar-expand-md fixed-top scrolling-navbar bg-white">
        <div class="container">
          <a class="navbar-brand" href="index.html"><img src="<?php echo base_url('assets/frontend/img/about/img-1.jpg'); ?>" width="40px" height="40px" alt=""> Schulogy</a>
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#services">Treatment</a>
              </li>
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#features">Cek Pesanan</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#blog">Produk</a>
              </li>
              <li class="nav-item">
        ...
        <div id="carousel-slider" class="carousel slide carousel-fade" data-ride="carousel">
          <?php $abc = 0;
            ...
            foreach ($slide as $a) {
              ...
              $indicators .= '<li data-target="#carousel-slider" data-slide-to="'. $abc .'" class="'. $class .'"></li>';
            }?>
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item <?php echo $class; ?>">
              <img src="<?php echo base_url('slidefoto/').$a->slider; ?>" width="100%" height="650px" alt="">
              <div class="carousel-caption text-left">
                <h3 class="wow fadeInRight" data-wow-delay="0.2s"><?php echo $a->caption1; ?></h1>
                <h2 style="color:black" class="wow fadeInRight" data-wow-delay="0.4s"><?php echo $a->caption2; ?></h2>
                <h4 class="wow fadeInRight" data-wow-delay="0.6s"><?php echo $a->caption3; ?></h4>
              </div>
              <div class="carousel-caption text-left">
              </div>
            </div>
            ...
            <div class="carousel-item active">
              <img src="<?php echo base_url('assets/frontend/'); ?>img/slider/bg-1.jpg" alt="">
              <div style="color:red;" class="carousel-caption text-left">
                <h3 style="color:blue;"class="wow fadeInRight" data-wow-delay="0.2s">Shoes Treatment</h1>
                <h2 style="color:#03F8FC;" class="wow fadeInRight" data-wow-delay="0.4s">SCHULOGY</h2>
                <h4 style="color:green;" class="wow fadeInRight" data-wow-delay="0.6s">Comes with All Essential Sections & Elements</h4>
              </div>
              <div class="carousel-caption text-left">
              </div>
            </div>
            <div class="carousel-item">
              <img src="<?php echo base_url('assets/frontend/'); ?>img/slider/bg-3.jpg" alt="">
              <div style="color:red;" class="carousel-caption text-left">
                <h3 style="color:blue;"class="wow fadeInRight" data-wow-delay="0.2s">SCHULOGY</h1>
                <h2 style="color:#03F8FC;" class="wow fadeInRight" data-wow-delay="0.4s">Shoes Treatment</h2>
                <h4 style="color:green;" class="wow fadeInRight" data-wow-delay="0.6s">Comes with All Essential Sections & Elements</h4>
              </div>
            ...
            <div class="carousel-item">
              <img src="<?php echo base_url('assets/frontend/'); ?>img/slider/bg-2.jpg" alt="">
              <div class="carousel-caption text-left">
                <h3 style="color:#03F8FC;"class="wow fadeInRight" data-wow-delay="0.2s">SCHULOGY</h1>
                <h2 style="color:#03F8FC;" class="wow fadeInRight" data-wow-delay="0.4s">Shoes Treatment</h2>
                <h4 style="color:#03F8FC;" class="wow fadeInRight" data-wow-delay="0.6s">Comes with All Essential Sections & Elements</h4>
              </div>
    ...
    <section id="services" class="section">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title">Our Treatment</h2>
          <span>Treatment</span>
          <p class="section-subtitle">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</p>
        </div>
        <div class="row">
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="item-boxes services-item wow fadeInDown" data-wow-delay="0.2s" onclick="alert('as');">
              <div class="icon color-4">
                <i><img src="<?php echo base_url('assets/img/oxford3.png') ?>" style="padding-bottom: 3px;" width="32px" height="32px" alt=""></i>
              </div>
              <h4>Unyellowing</h4>
              <p>Salah satu treatment kami dalam membersihkan dan menghilangkan noda kuning pada sepatu kamu. (Proses 4-5 Hari)</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="item-boxes services-item wow fadeInDown" data-wow-delay="0.4s">
              <div class="icon color-2">
                <i><img src="<?php echo base_url('assets/img/suitcase.png') ?>" style="padding-bottom: 3px;" width="25px" height="25px" alt=""></i>
              </div>
              <h4>Reparasi</h4>
              <p>Salah satu treatment kami dalam  memperbaiki sepatu, tas dan topi kamu yang ada kerusakan. (Proses 3 Hari)</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="item-boxes services-item wow fadeInDown" data-wow-delay="0.6s">
              <div class="icon color-3">
                <i><img src="<?php echo base_url('assets/img/hat.png') ?>" style="padding-bottom: 3px;" width="25px" height="25px" alt=""></i>
              </div>
              <h4>Repaint</h4>
              <p>Salah satu treatment kami dalam mewarnai kembali sepatu dan topi kamu yang telah memudar. (Proses 7-8 Hari)</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-xs-12">
            <a href="javascript:;">
            <div class="item-boxes services-item wow fadeInDown" data-wow-delay="0.8s">
              <div class="icon color-1">
                <i><img src="<?php echo base_url('assets/img/baseball-cap.png') ?>" style="padding-bottom: 3px;" width="25px" height="25px" alt=""></i>
              </div>
              <h4>Recolor</h4>
              <p>Salah satu treatment kami dalam mewarnai sepatu dan topi kamu dengan warna sesuai permintaan kamu. (Proses 7-8 Hari)</p>
            </div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="item-boxes services-item wow fadeInDown" data-wow-delay="1s">
              <div class="icon color-5">
                <i><img src="<?php echo base_url('assets/img/backpack.png') ?>" style="padding-bottom: 3px;" width="32px" height="32px" alt=""></i>
              </div>
              <h4>Deep Clean</h4>
              <p>Salah satu treatment kami dalam membersihkan sepatu, tas dan topi kamu secara menyeluruh. (Proses 3 Hari)</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="item-boxes services-item wow fadeInDown" data-wow-delay="1.2s">
              <div class="icon color-6">
                <i><img src="<?php echo base_url('assets/img/sepatu.png') ?>" style="padding-bottom: 3px;" width="32px" height="32px" alt=""></i>
              </div>
              <h4>Fast Clean</h4>
              <p>Salah satu treatment kami dalam membersihkan sepatu kamu dengan cepat. (Proses 30-35 menit)</p>
            </div>
          </div>
        </div>
      </div>
    </section>
    <!-- Schulogy Treatment END-->

    <!-- Cek Pesanan -->
    <section id="features" class="call-action section">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title">Cek Pesanan Anda</h2>
          <span>Cek </span>
          <p class="section-subtitle">Silahkan Masukkan Kode Pemesanan Anda<br> Lalu Klik Tombol Cek Pesanan</p>
        </div>
        <div class="row justify-content-center">
          <div class="col-md-6">
            <div class="form-group text-center">
              <input style="text-align: center; background:white;" type="text" class="form-control" id="name" name="kodepesanan" placeholder="Masukkan Kode Pesanan" required="required" data-error="Kan, Kamu Belum Masukin Kode Pesanannya Loh">
              <button type="submit" class="btn btn-common btn-effect" id="cekpesanan" >Cek Pesanan</button>
              <div class="help-block with-errors"></div>
            </div>
          </div>
        <!--  <div class="col-10">
            <div class="cta-trial text-center">
              <input style="text-align: center; background:white;" type="text" class="form-control col-8 mx-auto" name="kodepesanan" placeholder="Masukkan Kode Pemesanan">
              <a href="#" class="btn btn-common btn-effect">Cek Pesanan</a>
            </div>
          </div> -->
        </div>
        <div class="row justify-content-center"  id="infopesanan">
        </div>
      </div>
    </section>
    <!-- Cek Pesanan END -->
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
              <div class="video-promo-content text-center">
                <a href="https://www.youtube.com/watch?v=J7_uT8Lai5s" class="video-popup"><i class="lni-film-play"></i></a>
    ...
    <section id="portfolios" class="section">
      ...
      <div class="container">
        <div class="section-header">
          ...
          <span>Works</span>
          <p class="section-subtitle">Schulogy ni geng, bukan kaleng-kaleng.</p>
        </div>
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="controls text-center">
              ...
              <a class="filter btn btn-common btn-effect" data-filter=".repaint">
                Repaint
              </a>
              <a class="filter btn btn-common btn-effect" data-filter=".recolor">
                Deep Clean
              </a>
              <a class="filter btn btn-common btn-effect" data-filter=".unyellowing">
                Unyellowing
              </a>
            </div>
        ...
        <div id="portfolio" class="row">
          <div class="col-lg-4 col-md-6 col-xs-12 mix development print repaint">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="<?php echo base_url('assets/frontend/'); ?>img/portfolio/img-1.jpg" alt="" />
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix design print unyellowing">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="<?php echo base_url('assets/frontend/'); ?>img/portfolio/img-2.jpg" alt="" />
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix development recolor">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="<?php echo base_url('assets/frontend/'); ?>img/portfolio/img-3.jpg" alt="" />
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix development design">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="<?php echo base_url('assets/frontend/'); ?>img/portfolio/img-4.jpg" alt="" />
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix development">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="<?php echo base_url('assets/frontend/'); ?>img/portfolio/img-5.jpg" alt="" />
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix print design">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="<?php echo base_url('assets/frontend/'); ?>img/portfolio/img-6.jpg" alt="" />
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
            ...
            <div id="testimonials" class="touch-slider owl-carousel">
              <div class="item">
                <div class="testimonial-item">
                  <div class="author">
                    <div class="img-thumb">
                    <img src="<?php echo base_url('assets/frontend/'); ?>img/testimonial/img1.jpg" alt="">
                    </div>
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="author">
                    <div class="img-thumb">
                    <img src="<?php echo base_url('assets/frontend/'); ?>img/testimonial/img2.jpg" alt="">
                    </div>
                    <div class="author-info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="author">
                    <div class="img-thumb">
                    <img src="<?php echo base_url('assets/frontend/'); ?>img/testimonial/img3.jpg" alt="">
                    </div>
                    <div class="author-info">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="<?php echo base_url('assets/frontend/'); ?>img/team/team1.png" alt="">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="<?php echo base_url('assets/frontend/'); ?>img/team/team2.png" alt="">
              <div class="team-details">
                <div class="team-inner">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="<?php echo base_url('assets/frontend/'); ?>img/team/team3.png" alt="">
              <div class="team-details">
                <div class="team-inner">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="<?php echo base_url('assets/frontend/'); ?>img/team/team4.png" alt="">
              <div class="team-details">
                <div class="team-inner">
                  ...
                  <ul class="social-list">
                    <li class="facebook"><a href="#"><i class="lni-facebook-filled"></i></a></li>
                    <li class="twitter"><a href="#"><i class="lni-twitter-filled"></i></a></li>
                    <li class="instagram"><a href="#"><i class="lni-instagram-filled"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?php echo base_url('assets/frontend/'); ?>img/blog/img1.jpg" alt="">
                </a>
              </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?php echo base_url('assets/frontend/'); ?>img/blog/img2.jpg" alt="">
                </a>
              </div>
              <div class="blog-item-text">
                <div class="date"><i class="lni-calendar"></i>10 April, 2018</div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?php echo base_url('assets/frontend/'); ?>img/blog/img3.jpg" alt="">
                </a>
              </div>
              <div class="blog-item-text">
                <div class="date"><i class="lni-calendar"></i>10 April, 2018</div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              <div class="widget">
                ...
                <ul class="contact-footer">
                  <li>
                    <strong>Address :</strong> <span>JL. Arifin Ahmad Setelah <br> Kantor Camat Sebelum <br> Kantor Kemenag Disamping <br> Indomaret, Pekanbaru</span>
                  </li>
                  <li>
                    <strong>Phone :</strong> <span>+62 895 2355 8161</span>
                  </li>
                  <li>
                    <strong>E-mail :</strong> <span><a href="#">schulogy@gmail.com</a></span>
                  </li>
                </ul>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              <div class="widget">
                ...
                <ul class="instagram-footer">
                  <iframe src="http://instaembedder.com/gallery-v2.php?width=75&cols=3&rows=2&margin=1&color=gray&share_buttons=1&image_border=1&frame_color=white&cid=9548&" frameborder="0" width="330" height="258" ></iframe>              </div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="site-info float-left">
                <p>Copyright 2019 &copy;  <a href="http://uideck.com" rel="nofollow">Schulogy</a></p>
              </div>
  ...
  $(document).ready(function () {
    $("#cekpesanan").click(function () {
      ...
      $.ajax({
        url: '<?php echo base_url('frontend/cekpesanan') ?>',
        type: 'POST',
        data: {kode:kode},
        beforeSend: function() {
        ...
        success: function (data) {
          $("#cekpesanan").html("Cek Pesanan Anda").removeAttr("disabled");
          $("#infopesanan").css("background", "white");
           // $("#infopesanan").css("height", "100px");
          //$("#infopesanan").css("width", "500px");
          $("#infopesanan").html(data);
        },
        error: function () {
          $("#infopesanan").html("data tidak ditemukan");
          $("#cekpesanan").html("Cek Pesanan Anda").removeAttr("disabled");
        }
      });
    });
